...
SET LOGON_SERVER=RTX2DPSPW2C
SET LOGON_SERVER_DOMAIN=RTX2WMSDOM
SET LOGON_SCRIPT=\\RTX2DPSPW2C\WMS-RT\atl\runtime\etc\ClientFiles\LogonScript.bat
SET LOGON_LOG=\\RTX2DPSPW2C\WMS-LOG\Client_Startup\
