...
namespace Startup
{
    public class AutomationMethods
    {
        ...
        public AutomationElement setChildElementByAutomationId(AutomationElement parentElement, string nameProperty, bool skipElement)
        {
            ...
            do
            {
                if (parentElement != null)
                {
                    childElement = parentElement.FindFirst(TreeScope.Descendants, new PropertyCondition(AutomationElement.AutomationIdProperty, nameProperty));
                }
                elementCheck = enabledCheck(childElement);
                ct++;
                if (skipElement == true)
