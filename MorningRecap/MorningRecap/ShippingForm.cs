...
namespace MorningRecap
{
    public partial class ShippingForm : Form
    {
        ...
        {
            InitializeComponent();
            file = folder + "\\Shipping.csv";

            DBConn.ConnectToDatabase();
            DBConn.buildNameList(list1, "ShippingTable");
            DBConn.buildValueList(list2, "ShippingTable");
            DBConn.Disconnect();
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < (list2.Count - 1); i++)
            {
                ...
                DBConn.tableValueUpdate(id, value, "ShippingTable");
            }
