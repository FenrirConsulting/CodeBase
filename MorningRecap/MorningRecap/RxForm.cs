...
namespace MorningRecap
{
    public partial class RXForm : Form
    {
        ...
        public RXForm()
        {
            ...
            DBConn.buildNameList(list1, "RxTable");
            DBConn.buildValueList(list2, "RxTable");
            DBConn.Disconnect();
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < (list2.Count-1); i++) {
                ...
                DBConn.tableValueUpdate(id, value, "RxTable");
            }
        ...
        {
            var message = string.Join(Environment.NewLine, list1);
            var message2 = string.Join(Environment.NewLine, list2);
