...
namespace CVSHealth.IAM.IAPF.Tools.EnableDisable.Models
{
    ...
    public class EnableTableItem
    {
        ...
        /// </summary>
        public ADUserDetails? UserDetails { get; set; }
        #endregion
        ...
        public EnableTableItem(string status, string comment, string action, string scope, string domain, string samAccount, string disableComment, ADUserDetails? userDetails)
        {
            Status = status;
            Comment = comment;
            Action = action;
